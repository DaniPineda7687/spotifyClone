...
<body>
    ...
    <header class="header__container">
         <div class="logo__container nav__logo">
            <a href="index.html">
         ...
         <div class="nav__container">
            <div class="menu__hamburguer">
                <span class="burguer__top"></span>
                <span class="burguer__medium"></span>
                <span class="burguer__bottom"></span>
            </div>
            <nav class="nav">
    ...
    <main>
        <div class="main__container">
            <div class="main__content">
                <h1>Escuchar <br> es todo</h1>
                <p>
                    Millones de canciones y podcasts. No necesitas tarjeta de crédito.
                </p>
                <a class="button__buy" href="">OBTENER SPOTIFY FREE</a>
            </div>
        </div>
    </main>
    ...
    <footer>
        <div class="footer__container">
            ...
            <div class="social__links__content">
                <div class="social__link link__footer">
